...
import styles from "../styles/termsAndPrivacy.module.scss"
    ...
    <div className={styles.container}>
      ...
      <main className={styles.mainContainer}>
        <p className={styles.paragraph}>
          本利用規約（以下「本規約」と言います。）には、「REANE」（以下「当方」といいます。）がこのウェブサイトで提供するサービス（以下「本サービス」といいます。）の提供条件及び当方と登録ユーザーの皆様との間の権利義務関係が定められています。本サービスの利用に際しては、本規約の全文をお読みいただいたうえで、本規約に同意いただく必要があります。
        </p>
        ...
        <ol className={styles.paragraph}>
          ...
          <li className={styles.list}>
            ...
            <Link href="/terms">https://reane.site/terms</Link>
            ）は、本規約の一部を構成するものとします。
          </li>
          <li className={styles.list}>
        ...
        <ol className={styles.paragraph}>
          <li className={styles.list}>
            ...
            <Link href="/privacy">https://reane.site/privacy</Link>
